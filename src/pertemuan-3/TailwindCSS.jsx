export default function TailwindCSS() {
    return (
        <div>
            <h1 class="border-2 m-4 border-green-400 bg-green-200">Belajar Tailwind CSS 4</h1>
            <button className="bg-blue-500 text-white 
                                px-4 py-2 mx-4 rounded-lg
...
function ShadowEffects(){
    return (
        <div className="bg-white shadow-lg p-4 rounded-lg hover:shadow-blue-600 transition">
